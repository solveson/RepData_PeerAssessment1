...
So 8 days are missing all values.  Also, 8 x 288 = `r 8*288`, which is our total number of missing values.  Thus, each day in the sample either had all values missing or no values missing.  This explains the increase in the *Frequency* scale.
...
There are no remaining dummy values, and the ratio of weekend to weekday days is `r 4608/12960`, which is appropriate, given that the period covered nine weeks minus two weekend days.  
